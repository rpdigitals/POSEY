$(function () {
    ...
    $("#countdown").each(function () {
        ...
        $this.countdown(finalDate, function (event) {
            $this.html(
                event.strftime(
                    '<div class="count-box days"><span class= "time-count">%-D</span><span class="labels">Jours<span></div><div class="count-box hour"><span class="time-count">%-H</span> :<span class="labels">Heures</span></div><div class="count-box minutes"><span class="time-count">%-M</span> :<span class="labels">Mins</span></div><div class="count-box cdown second"><span class="time-count">%-S</span><span class="labels">Secs</span></div>'
                )
            );
        });
    });
