                    ...
                    <div class="card-body">
                        ...
                        <div class="wallet-details">
                            ...
                            <div class="d-flex justify-content-between my-4">
                                <div>
                                    <p class="mb-1">Total reçu</p>
                                    <h4>{{ $total_recu }}</h4>
                                </div>
                                <div>
                                    <p class="mb-1">Total débité</p>
                                    <h4>{{ $total_recu -\Auth()->user()->porte_feuille()->valeur }}</h4>
                                </div>
                            </div>
                        ...
                        <tbody>
                            @foreach ($transactions as $transaction)
                                <tr>
                                    ...
                                    <td><a
                                            href="provider_edit_service/{{ $transaction->commande->service->id }}">{{ $transaction->commande->client->nom . ' ' . $transaction->commande->client->prenom }}</a>
                                    </td>
