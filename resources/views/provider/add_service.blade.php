                    ...
                    <li class="nav-item dropdown logged-item">
                        ...
                        <div class="dropdown-menu notify-blk dropdown-menu-end notifications">
                            ...
                            <div class="topnav-dropdown-footer">
                                <a href="/provider_notifications">Voir tout</a>
                            </div>
                        </div>
                    </li>
                    <!-- /Notifications -->
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <form method="POST" action="/provider_add_service" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                    ...
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" required
                                                ...
                                                maxlength="30" name="nom_du_service" placeholder="Ex: Réparation d'ordinateurs">
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            <label>Prix du Service (XOF)<span class="text-danger">*</span></label>
                                            <input class="form-control" type="number" required name="prix" placeholder="Ex: 2500">
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            <label>Description du service<span class="text-danger">*</span></label>
                                            <textarea class="form-control" required name="description" maxlength="400" placeholder="Maximum: 400 caractères"></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="service-fields mb-3">
                                ...
                                <div class="service-fields mb-3">
                                    ...
                                    <div class="form-group col-xl-7">
                                        ...
                                        <input type="file" class="form-control" required name="image_illustration"
                                            accept="image/*">
